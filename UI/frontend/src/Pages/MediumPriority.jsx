...
export default function MediumPrirority() {
  const [MediumPrirorityEmails, setMediumPrirorityEmails] = useState({ Subject: {}, Message: {}, Priority: {} });
  ...
  useEffect(() => {
    ...
    const fetchData = async () => {
      try {
        ...
        setMediumPrirorityEmails(data[1] || { Subject: {}, Message: {}, Priority: {} }); // Ensure it's an object or set to an empty object by default
      } catch (error) {
